...
class CaptioningRNN(object):
  ...
  def loss(self, features, captions):
    ...
    ############################################################################
    # setp 1
    h0, affine1_cache = affine_forward(features, W_proj, b_proj)
    ...
    # step 5
    loss, dout = temporal_softmax_loss(x_affine_out, captions_out, mask)

    ############################################################################
    # Backward
    ############################################################################
    dout, dW, db = temporal_affine_backward(dout, affine2_cache)
    grads['W_vocab'] = dW
    grads['b_vocab'] = db
    ...
    dout, dW, db = affine_backward(dh0, affine1_cache)
    grads['W_proj'] = dW
    grads['b_proj'] = db
